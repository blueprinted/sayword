...
//https://appcdn.fanyi.baidu.com/zhdict/mp3/pin3.mp3
// https://hanyu-word-pinyin-short.cdn.bcebos.com/chang2.mp3
...
foreach ($param as $pinyin) {
    ...
    if (!file_exists(APP_ROOT."/data/audio/{$pinyin}.mp3")) {
        ...
        $cmd = "cd ".APP_ROOT."/data/audio/ && wget --no-check-certificate https://hanyu-word-pinyin-short.cdn.bcebos.com/{$pinyin}.mp3";
